...
import stylesCss from 'themes/abc_insurance/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_abc_insurance_componentCss']) {
    
    document['_vaadintheme_abc_insurance_componentCss'] = true;
  }
